...
const resumeTemplates_routes_1 = __importDefault(require("./resumeTemplates.routes"));
...
router.use('/seeker/referrals', referrals_routes_1.default);
router.use('/security', security_routes_1.default);
router.use('/reports', reports_routes_1.default);
router.use('/hirer/verification', verification_routes_1.default);
router.use('/resume-templates', resumeTemplates_routes_1.default);
