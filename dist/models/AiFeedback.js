...
const aiFeedbackSchema = new mongoose_1.Schema({
...
exports.AiFeedback = mongoose_1.default.models.AiFeedback ||
    mongoose_1.default.model('AiFeedback', aiFeedbackSchema);
