...
exports.SalarySubmission = void 0;
const mongoose_1 = __importStar(require("mongoose"));
const submissionSchema = new mongoose_1.Schema({
    user: { type: mongoose_1.Schema.Types.ObjectId, ref: 'User', sparse: true },
...
submissionSchema.index({ user: 1, role: 1, city: 1 }, {
    unique: true,
    partialFilterExpression: { user: { $exists: true } },
});
exports.SalarySubmission = mongoose_1.default.model('SalarySubmission', submissionSchema);
