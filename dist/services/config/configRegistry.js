...
exports.CONFIG_REGISTRY = [
    ...
    },
    {
        ...
        category: 'job-board',
        isSecret: false,
        description: 'Override OpenWebNinja JSearch endpoint (defaults to the canonical /jsearch/search URL in constants.ts).',
        usedBy: 'services/scrapers/rapidapi.service.ts',
    },
    {
        ...
        category: 'job-board',
        isSecret: false,
        description: 'Override OpenWebNinja Realtime Web Search endpoint (defaults to /realtime-web-search/search).',
    ...
    },
    {
        ...
        category: 'job-board',
        isSecret: false,
        description: 'Override the legacy RapidAPI JSearch endpoint. Only consulted when RAPIDAPI_KEY (not OpenWebNinja) is in use.',
        usedBy: 'services/scrapers/rapidapi.service.ts',
    },
    {
        key: 'SERPAPI_KEY',
